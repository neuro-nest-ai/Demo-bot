...
# Creating an instance of PdfConfigModel
data = PdfConfigModel()

# Processing and storing PDFs
data.storing_db(pdf_files)

# User question
user_question = "Give me President name"

# Getting and printing the response
response_text = data.user_input(user_question)
print(response_text)
